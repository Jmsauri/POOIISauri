namespace ProgramacionOrientadaObjetosII
{
	partial class MenuPuntodeVenta
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Captura de Productos";
			this.button1.UseVisualStyleBackColor = true;
			this.button1.Click += new System.EventHandler(this.button1_Click);
			// 
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(142, 382);
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(387, 382);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(125, 47);
			this.button4.TabIndex = 3;
			this.button4.Text = "Checador Empleados";
			...
			this.label1.Text = "Menu Punto de Venta";
			// 
			// label3
			// 
			...
			this.label2.Text = "Productos FAF :)";
			// 
			// MenuPuntodeVenta
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.BackgroundImage = global::ProgramacionOrientadaObjetosII.Properties.Resources.caldiabl_1_;
